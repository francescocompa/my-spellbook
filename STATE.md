...
- **His six-item report: four closed, two open (v1.5.44 + v1.5.45, D186 + D187).** Closed —
  ...
  on the public build) superseded by the import that names it. And the swap rework shipped as
  **v1.5.46, D188** — his own shape off `swap1`: Giving up and Learning instead are two rows,
...
- **Manual for Francesco:** ① the **copy-veto pass** over `audits/copy-table.md` (now 245
  ...
  **Access** for the old "Class / list" and **Properties** for "Tags"); ② confirm on the live
  ...
  re-reads); ④ **try the reworked trade** on a real build (v1.5.46);
